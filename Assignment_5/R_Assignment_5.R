...
setwd("/Users/riyasingh/Documents/rAssignments")

# 9. Read a CSV file from your local system into an R data frame.
data <- read.csv("customers-100.csv")

# 10. Read a CSV file from an online source into an R data frame.
data_url <- read.csv("https://raw.githubusercontent.com/uiuc-cse/data-fa14/gh-pages/data/iris.csv")
